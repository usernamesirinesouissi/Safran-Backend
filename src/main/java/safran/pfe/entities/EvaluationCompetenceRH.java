...
@Entity
@Table(name = "evaluation_competence")
public class EvaluationCompetenceRH {
    @Id
    ...
    //@JsonBackReference("evaluation-rh") 
    private EvaluationStage evaluation;

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "competence_id", nullable = false) // <--- THIS IS THE FIX
